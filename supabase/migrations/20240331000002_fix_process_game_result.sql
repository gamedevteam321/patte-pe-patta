-- Migration: Fix Process Game Result
-- Description: Updates the process_game_result_with_notification function to work without VIP dependencies
-- Date: 2024-03-31

-- Update process_game_result_with_notification without VIP dependencies
...
BEGIN
    -- No VIP bonus multiplier - use flat amount
    v_final_amount := CASE
